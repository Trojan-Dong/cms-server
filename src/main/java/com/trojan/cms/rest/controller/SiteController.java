...
import com.trojan.cms.rest.entity.Site;
import com.trojan.cms.rest.service.SiteService;
...
public class SiteController {
    ...
    public Result page(UserPrincipal userPrincipal, @RequestBody JSONObject jsonObject) {
        ...
        return Result.success(
                new PageResult(sitePage.getCurrent(), sitePage.getSize(), sitePage.getPages(), sitePage.getTotal(),
                        sitePage.getRecords()));
    }
